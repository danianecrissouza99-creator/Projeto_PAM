...
class GamesQueryNotifier extends Notifier<GamesQuery> {
  ...
  void setSearch(String value) {
    state =
        GamesQuery(search: value, ordering: state.ordering, genres: state.genres);
  }

  void setOrdering(String? value) {
    state =
        GamesQuery(search: state.search, ordering: value, genres: state.genres);
  }

  void setGenres(String? value) {
    state =
        GamesQuery(search: state.search, ordering: state.ordering, genres: value);
  }
}
